...
**Tests**: The examples below include test tasks. Tests are MANDATORY for every executable user story, per the project constitution's Test-First Development principle. Omit them only under a constitution-approved exception for that specific work.
...
### Tests for User Story 1 (MANDATORY per Test-First Development) ⚠️

> **NOTE: Write these tests FIRST, ensure they FAIL before implementation**

- [ ] T010 [P] [US1] Contract test for [endpoint] in tests/contract/test_[name].py
- [ ] T011 [P] [US1] Integration test for [user journey] in tests/integration/test_[name].py
- [ ] T012 [P] [US1] Unit test for [function/module under test] in tests/unit/test_[name].py
...
### Tests for User Story 2 (MANDATORY per Test-First Development) ⚠️
...
- [ ] T021 [P] [US2] Unit test for [function/module under test] in tests/unit/test_[name].py
...
### Tests for User Story 3 (MANDATORY per Test-First Development) ⚠️
...
- [ ] T028 [P] [US3] Unit test for [function/module under test] in tests/unit/test_[name].py
...
- [ ] TXXX [P] Additional unit tests beyond per-story coverage (edge cases, regressions) in tests/unit/
